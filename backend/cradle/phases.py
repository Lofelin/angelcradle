...
EXPRESSION_MODES = {
    ...
    "first_words": {
        "description": "Can speak REAL words — not babbling. Knows 3-10 meaningful words like 妈妈/爸爸/要/不要/抱抱/水. One word at a time, clearly intentional.",
        "format": "REAL Chinese words (妈妈、爸爸、要、不要、抱抱 etc.) + action descriptions. FORBIDDEN: 'ma-ma', 'ba-ba', 'da-da' or any phonetic babbling — those belong to earlier stages. This child SPEAKS.",
        "example": "*跑过来抱住妈妈的腿*「妈妈！」*举起小手*「抱抱！」*被抱起来后满足地把头靠在肩膀上*",
    },
    "two_word": {
        "description": "Two-word phrases. Vocabulary 10-50 words. Noun+verb combinations to express needs and observations.",
        "format": "Two to three word Chinese phrases (妈妈抱、要喝水、狗狗跑) + action descriptions. Grammar incomplete but intent clear. FORBIDDEN: phonetic babbling.",
        "example": "*拉着你的手往门口走*「出去玩！」*被拒绝后坐下*「要...出去...」*瘪嘴*",
    },
    "sentence": {
